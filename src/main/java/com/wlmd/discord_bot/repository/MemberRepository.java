...
public interface MemberRepository extends JpaRepository<MemberModel, Integer> {
	...
	MemberModel findByGuild_GuildIdAndDiscordUserId(Long guildId, Long discordUserId);
	
	List<MemberModel> findAllByGuild_GuildId(Long guildId);
	...
	@Query("""
		       ...
		       """)
	List<MemberModel> findAllByGuild_GuildIdWithRoles(@Param("guildId") Long guildId);
